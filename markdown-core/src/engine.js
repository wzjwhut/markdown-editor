      ...
      switch (plugin) {
        ...
        case 'github-toc':
          this.mdc.use(markdownItGithubToc, {
            tocFirstLevel: (globalConfig==undefined||globalConfig.tocFirstLevel==undefined)?1:globalConfig.tocFirstLevel,
            tocLastLevel: (globalConfig==undefined||globalConfig.tocLastLevel==undefined)?3:globalConfig.tocLastLevel,
            tocClassName: 'toc',
            anchorLinkSymbol: '',
